...
1. `proxyPlatform()` - 92 edges
2. `buildPlatformMux()` - 83 edges
3. `createTestMatch()` - 81 edges
4. `T` - 77 edges
5. `applyTestIntent()` - 74 edges
6. `NewMatchArchiveStore()` - 67 edges
7. `NewGuestStore()` - 61 edges
8. `MatchState` - 54 edges
9. `T` - 51 edges
...
Cohesion: 0.09
Nodes (45): nullableTime(), normalizeAccountHandle(), deleteOtherPostgresAccountSessions(), deletePostgresAccountSessionRecord(), insertPostgresAccountEmailVerificationTx(), insertPostgresAccountPasswordResetTx(), insertPostgresAccountSessionRecordTx(), insertPostgresAccountTx() (+37 more)
...
Cohesion: 0.11
Nodes (52): AccountPresenceStatus, BuildPublicAccountPresence(), buildPublicAccountPresenceAt(), resolveAccountLastActiveAt(), touchAccountPresence(), AccountHasSeason(), AccountHasSeasonForMode(), accountSeasonIDForTime() (+44 more)

### Community 13 - "Community 13"
Cohesion: 0.06
Nodes (30): normalizeAccountSecurityEventKind(), normalizeAccountSecurityEventRequest(), NewPostgresAccountSecurityAuditStore(), scanPostgresAccountSecurityEvent(), NewSQLiteAccountSecurityAuditStore(), scanSQLiteAccountSecurityEvent(), accountSecurityAuditPersistence, AccountSecurityAuditStats (+22 more)
...
Cohesion: 0.10
Nodes (25): cloneArchiveEntry(), cloneBoard(), cloneEvents(), cloneMatchState(), clonePayload(), clonePositionHistory(), cloneReplayFrames(), cloneSnapshot() (+17 more)

### Community 21 - "Community 21"
Cohesion: 0.13
Nodes (32): Header, bucket, Limiter, ClientIP(), ContentTypeMiddleware(), CSRFMiddleware(), equalFoldOrigin(), firstForwardedValue() (+24 more)
...
Cohesion: 0.09
Nodes (17): Route(), Route(), Route(), Route(), usePlatform(), Route(), HistoryRouteClient(), HistoryRouteClientProps (+9 more)
...
Cohesion: 0.14
Nodes (13): AccountNotification, AccountNotificationEvent, AccountNotificationOptions, AccountNotificationOverview, AccountNotificationStore, AccountNotificationStoreStats, fileNotificationStore, notificationPersistence (+5 more)

### Community 36 - "Community 36"
Cohesion: 0.12
Nodes (23): GET(), GET(), backendBaseUrl, filterHeaders(), filterResponseHeaders(), proxyRealtime(), isLocalRequest(), POST() (+15 more)
...
Cohesion: 0.13
Nodes (5): MatchStore, RedisMatchStore, extractMatchID(), NewRedisMatchStore(), Client

### Community 44 - "Community 44"
Cohesion: 0.15
Nodes (26): build, deploy, builder, dockerfilePath, healthcheckPath, healthcheckTimeout, restartPolicyMaxRetries, restartPolicyType (+18 more)
...
Cohesion: 0.16
Nodes (12): fileFriendshipStore, FriendRequest, Friendship, FriendshipOverview, friendshipPersistence, FriendAccountForViewer(), normalizeFriendshipPair(), FriendshipStore (+4 more)
...
Cohesion: 0.29
Nodes (12): newPlatformAuthThrottle(), requestClientIP(), throttleClientKey(), throttleIdentityKey(), writeAuthRateLimitError(), authRateBucket, platformAuthThrottle, Duration (+4 more)
...
Cohesion: 0.10
Nodes (20): dependencies, @chess404/contracts, @chess404/game-core, next, react, react-dom, devDependencies, @types/node (+12 more)
...
Cohesion: 0.17
Nodes (11): NewPostgresAccountStore(), newPostgresAccountStoreWithDB(), TestPostgresAccountStoreClaimGuestTouchesExistingAccount(), TestPostgresAccountStoreEnablePasswordLoginAndLoginByEmail(), TestPostgresAccountStoreResumeAccountByToken(), PostgresAccountStore, AccountProfile, AccountStoreStats (+3 more)

### Community 71 - "Community 71"
Cohesion: 0.18
Nodes (12): Job, buildMoveRecords(), main(), squareLabel(), Result, Worker, AnalysisResult, Client (+4 more)
...
Cohesion: 0.16
Nodes (10): newSQLiteFriendshipPersistence(), NewSQLiteFriendshipStore(), TestFriendshipStoreRequestLifecycle(), TestFriendshipStoreReverseRequestAutoAccepts(), sqliteFriendshipStore, DB, FriendRequest, Friendship (+2 more)
...
Cohesion: 0.17
Nodes (9): newPostgresFriendshipPersistenceWithDB(), NewPostgresFriendshipStore(), TestPostgresFriendshipStoreLoadAndPersist(), postgresFriendshipStore, DB, FriendRequest, Friendship, FriendshipStore (+1 more)

### Community 79 - "Community 79"
Cohesion: 0.27
Nodes (14): AnalyzeGame(), applyMoveToBoard(), avgInt(), cloneBoard(), evaluateAfterMove(), makeBoard(), maxInt(), parseSquare() (+6 more)
...
Cohesion: 0.27
Nodes (11): AnalysisResult, CheatFlag, GameRecord, MoveRecord, TimeProfile, AnalyzeTimeProfile(), mean(), stddev() (+3 more)
...
Cohesion: 0.18
Nodes (9): AuthoritativePage(), dangerButton, emptyStyle, headingStyle, panelStyle, preStyle, primaryButton, secondaryButton (+1 more)

### Community 96 - "Community 96"
Cohesion: 0.24
Nodes (6): newPostgresDirectChallengePersistenceWithDB(), NewPostgresDirectChallengeStore(), postgresDirectChallengeStore, DB, DirectChallenge, DirectChallengeStore
...
Cohesion: 0.25
Nodes (5): newSQLiteArchiveStore(), sqliteArchiveStore, DB, MatchArchiveEntry, MatchArchivePrivateEntry

### Community 102 - "Community 102"
Cohesion: 0.20
Nodes (9): Card System, Chess404 Architecture, Data Flow, Game Engine, Infrastructure, Monorepo Structure, Overview, Security (+1 more)
...
Cohesion: 0.24
Nodes (5): fileArchiveStore, newFileArchiveStore(), archivePersistence, MatchArchiveEntry, MatchArchivePrivateEntry
...
Cohesion: 0.33
Nodes (5): Chess404, Local development, Quality checks, Railway staging deploy, Stack
